...
describe("Share API - /api/share", () => {
  ...
  describe("POST /api/share", () => {
    ...
    it("should create share link for list", async () => {
      ...
      expect(mockCreateShareLink).toHaveBeenCalledWith("user-123", "list", "list-123", undefined, undefined, undefined, undefined);
    });
    ...
    it("should create share link for project", async () => {
      ...
      expect(mockCreateShareLink).toHaveBeenCalledWith("user-123", "project", "project-123", undefined, undefined, undefined, undefined);
    });
    ...
    it("should create share link with expiry", async () => {
      ...
      expect(mockCreateShareLink).toHaveBeenCalledWith("user-123", "list", "list-123", 7, undefined, undefined, undefined);
    });
