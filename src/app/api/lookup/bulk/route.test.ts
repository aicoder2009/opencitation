...
import { POST as mockLookupUrl } from '@/app/api/lookup/url/route';
import { POST as mockLookupDoi } from '@/app/api/lookup/doi/route';
import { POST as mockLookupIsbn } from '@/app/api/lookup/isbn/route';
...
describe('Bulk Lookup API', () => {
  ...
  it('routes URLs to lookupUrl handler', async () => {
    (mockLookupUrl as ReturnType<typeof vi.fn>).mockResolvedValueOnce(
  ...
  it('routes DOIs to lookupDoi handler', async () => {
    (mockLookupDoi as ReturnType<typeof vi.fn>).mockResolvedValueOnce(
  ...
  it('routes ISBNs to lookupIsbn handler', async () => {
    (mockLookupIsbn as ReturnType<typeof vi.fn>).mockResolvedValueOnce(
