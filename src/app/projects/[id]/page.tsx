...
export default function ProjectDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const fetchProjectAndLists = useCallback(async () => {
    try {
      ...
      // OPTIMIZATION: Removed redundant API request to `/api/projects/${projectId}/lists`.
      // Deriving the subset in-memory from the global `/api/lists` collection to avoid duplicate database queries.
      ...
      if (allListsResult.success) {
        ...
        // Filter lists belonging to this project in-memory
