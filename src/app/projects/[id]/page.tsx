...
export default function ProjectDetailPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
      <WikiLayout>
        <div className="flex items-center justify-center py-12">
          <svg className="animate-spin h-5 w-5 text-wiki-text-muted" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" aria-label="Loading">
  ...
  if (isLoading) {
    return (
      <WikiLayout>
        <div className="flex items-center justify-center py-12">
          <svg className="animate-spin h-5 w-5 text-wiki-text-muted" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" aria-label="Loading project">
            <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4" />
            <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v4a4 4 0 00-4 4H4z" />
          </svg>
        </div>
