...
export default function ProjectDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const fetchProjectAndLists = useCallback(async () => {
    try {
      ...
      // (TTFB) and overall load time. Further optimized to derive project lists in-memory
      // from allListsRes instead of making a redundant API request.
      ...
      if (allListsResult.success) {
        ...
        // Derive project-specific lists in-memory to avoid a redundant API call
