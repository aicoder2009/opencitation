          ...
          <>
            ...
            <div className="flex flex-wrap gap-3 mb-3">
              <button
                ...
                aria-label={copiedKey === "copy" ? "Citation copied!" : "Copy citation"}
              >
              ...
              {citation.fields && (
                <button
                  ...
                  aria-label={copiedKey === "copy-in-text" ? "In-text citation copied!" : `Copy in-text citation (${citation.style.toUpperCase()})`}
                >
